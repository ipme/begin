	...
	<div id="container">
		<div id="usertab">
			<ul class="resp-tabs-list hor_1 resp-tab-active">
				<li class="myli"><i class="be be-timerauto"></i><?php _e( '我的信息', 'begin' ); ?></li>
				...
				<?php if ( zm_get_option( 'shar_favorite' ) ) { ?>
					<li><i class="be be-star "></i><?php _e( '我的收藏', 'begin' ); ?></li>
				<?php } ?>

				<?php if ( zm_get_option( 'follow_btn' ) ) { ?>
					<li><i class="be be-favoriteoutline"></i><?php _e( '我的关注', 'begin' ); ?></li>
				<?php } ?>

				<?php if ( zm_get_option( 'follow_btn' ) ) { ?>
					<li><i class="be be-favorite"></i><?php _e( '我的粉丝', 'begin' ); ?></li>
				<?php } ?>

				<?php if ( zm_get_option( 'tou_admin_url' ) ) { ?>
					<li class="tou-url"><a href="<?php echo home_url(); ?>/wp-admin/post-new.php" target="_blank"><i class="be be-edit"></i><?php echo zm_get_option( 'tou_txt' ); ?></a></li>
				<?php } else { ?>
					<?php if ( zm_get_option( 'tou_url' ) ) { ?>
					<li class="tou-url"><a href="<?php echo get_permalink( zm_get_option( 'tou_url' ) ); ?>" target="_blank"><i class="be be-edit"></i><?php echo zm_get_option( 'tou_txt' ); ?></a></li>
					<?php } ?>
				<?php } ?>
			</ul>
			...
			<div class="resp-tabs-container hor_1">
				...
				<div>
					<h4><?php _e( '我的文章', 'begin' ); ?><span class="m-number"><?php echo count_user_posts( $current_user->ID, array( 'post', 'bulletin', 'picture', 'video', 'tao', 'sites' ), false ); ?><span></h4>
				...
				<?php if ( zm_get_option( 'tou_admin_url' ) || zm_get_option( 'tou_url' ) ) { ?>
					<div>
