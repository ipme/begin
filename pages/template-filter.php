...
<?php wp_body_open(); ?>
<div id="page" class="hfeed site<?php page_class(); ?><?php if ( is_array( zm_get_option( 'body_width' ) ) && in_array( 'percent', zm_get_option( 'body_width' ) ) ) { ?> percent<?php } ?><?php if ( zm_get_option( 'be_debug' ) ) { ?> debug<?php } ?><?php if ( ! zm_get_option( 'turn_small' ) ) { ?> nav-normal<?php } ?>">
