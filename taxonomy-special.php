	...
	<?php if ( ! zm_get_option( 'ajax_layout_code_a_r' ) ) { ?><div class="ajax-content-area content-area"><?php } else { ?><div id="primary" class="ajax-content-area content-area"><?php } ?>
		<main id="main" class="site-main ajax-site-main<?php if ( zm_get_option( 'post_no_margin') ) { ?> domargin<?php } ?>" role="main">
			<?php 
				...
				echo do_shortcode( '[be_ajax_post posts_per_page="' . zm_get_option( 'ajax_special_code_img_n' ) . '" column="' . zm_get_option( 'ajax_layout_code_a_f' ) . '" special="true" btn_all="no" btn="no" terms="' . get_queried_object_id() . '" more="' . zm_get_option( 'nav_btn_a' ) . '" infinite="' . zm_get_option( 'more_infinite_a' ) . '" meta_key="' . $meta_key . '" orderby="' . $orderby . '" order="DESC"]' );
			?>
		</main>
		<div class="clear"></div>
	</div>
	...
	<?php if ( ! zm_get_option( 'ajax_layout_code_c_r' ) ) { ?><div class="ajax-content-area content-area"><?php } else { ?><div id="primary" class="ajax-content-area content-area"><?php } ?>
		<main id="main" class="site-main ajax-site-main<?php if ( zm_get_option( 'post_no_margin') ) { ?> domargin<?php } ?>" role="main">
			<?php 
				...
				echo do_shortcode( '[be_ajax_post posts_per_page="' . zm_get_option( 'ajax_special_code_title_n' ) . '" column="' . zm_get_option( 'ajax_layout_code_c_f' ) . '" style="title" special="true" btn_all="no" btn="no" terms="' . get_queried_object_id() . '" more="' . zm_get_option( 'nav_btn_c' ) . '" infinite="' . zm_get_option( 'more_infinite_c' ) . '" meta_key="' . $meta_key . '" orderby="' . $orderby . '" order="DESC"]' );
			?>
		</main>
		<div class="clear"></div>
	</div>
	...
	<?php if ( ! zm_get_option( 'ajax_layout_code_f_r' ) ) { ?><div class="ajax-content-area content-area"><?php } else { ?><div id="primary" class="ajax-content-area content-area"><?php } ?>
		<main id="main" class="site-main ajax-site-main<?php if ( zm_get_option( 'post_no_margin') ) { ?> domargin<?php } ?>" role="main">
			<?php 
				...
				echo do_shortcode( '[be_ajax_post posts_per_page="' . zm_get_option( 'ajax_special_code_list_n' ) . '" style="list" special="true" btn_all="no" btn="no" terms="' . get_queried_object_id() . '" more="' . zm_get_option( 'nav_btn_f' ) . '" infinite="' . zm_get_option( 'more_infinite_f' ) . '" meta_key="' . $meta_key . '" orderby="' . $orderby . '" order="DESC"]' );
			?>
		</main>
		<div class="clear"></div>
	</div>
...
<div id="primary" class="content-area">
	<main id="main" class="site-main ajax-site-main<?php if ( zm_get_option( 'post_no_margin') ) { ?> domargin<?php } ?>" role="main">
		<?php 
			...
			echo do_shortcode( '[be_ajax_post posts_per_page="' . zm_get_option( 'ajax_special_code_default_n' ) . '" style="default" special="true" btn_all="no" btn="no" terms="' . get_queried_object_id() . '" more="' . zm_get_option( 'nav_btn_d' ) . '" infinite="' . zm_get_option( 'more_infinite_d' ) . '" meta_key="' . $meta_key . '" orderby="' . $orderby . '" order="DESC"]' );
		?>
	</main>
	<div class="clear"></div>
</div>
