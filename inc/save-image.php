	...
	switch ( $ext ) {
		case 'tmp':
			if ( rename( $file, str_replace( 'tmp', $type, $file ) ) ) {
				if ( 'webp' == $type ) {
					return bes_image_convert( $file_dir . '/' . str_replace( 'tmp', $type, $file_name ), 'webp', 'jpeg' );
				}
				return $file_dir . '/' . str_replace( 'tmp', $type, $file_name );
			}
		case 'webp':
			if ( 'webp' == $type ) {
				return bes_image_convert( $file, 'webp', 'jpeg' );
			} elseif ( rename( $file, str_replace( 'webp', $type, $file ) ) ) {
...
function bes_image_convert( $image, $from = 'webp', $to = 'jpeg' ) {
