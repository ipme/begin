			...
			<div class="user-info">
				...
				<div class="user-info-min">
					...
					<?php } ?>
						...
						<?php } else { ?>
							<div class="usericon user-no-avatars">
								<div class="usericon-place"><?php _e( '您好！', 'begin' ); ?></div>
							</div>
						<?php } ?>
					</a>
			...
			<?php if ( ! is_user_logged_in() ){ ?>
				<div class="nav-set">
				 	<div class="nav-login-l">
						<a href="<?php echo zm_get_option( 'user_l' ); ?>" rel="external nofollow" target="_blank"><?php _e( '登录', 'begin' ); ?></a>
					</div>
				</div>
			<?php } ?>
		<?php } else { ?>
			<?php if ( ! is_user_logged_in() ){ ?>
				<div class="nav-set">
				 	<div class="nav-login">
						<div class="show-layer<?php echo cur(); ?>"><?php _e( '登录', 'begin' ); ?></div>
					</div>
				</div>
			<?php } ?>
		<?php } ?>
		...
		<?php if ( zm_get_option( 'menu_reg' ) && ! is_user_logged_in() && get_option( 'users_can_register' ) ) { ?>
			<div class="nav-set">
				 <div class="nav-reg nav-reg-no">
					<a class="hz" href="<?php echo zm_get_option( 'reg_l' ); ?>" rel="external nofollow" target="_blank"><?php _e( '注册', 'begin' ); ?></a>
				</div>
				<div class="clear"></div>
			</div>
		<?php } ?>
...
function my_data() {
	global $current_user;
 ?>
<div class="my-info<?php if ( get_bloginfo( 'language' ) === 'en-US' ) { ?> my-info-en<?php } ?>">
	...
	<?php
		...
		echo '<li><strong>' . __( '文章', 'begin' ) . '</strong>' . count_user_posts( $current_user->ID, array( 'post', 'bulletin', 'picture', 'video', 'tao', 'sites' ), false ) . '</li>';
...
function my_tou() { ?>
	<div class="m-tou">
		<?php if ( zm_get_option( 'tou_admin_url' ) ) { ?>
			<p><a href="<?php echo home_url(); ?>/wp-admin/post-new.php" target="_blank"><i class="be be-editor ri"></i><?php _e( '点击跳转到投稿页面', 'begin' ); ?></a></p>
		<?php } else { ?>
