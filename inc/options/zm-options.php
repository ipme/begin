	...
	array(
		...
		'fields'      => array(
			...
			array(
				...
				'type'    => 'content',
				'content' => '
				<b>不裁剪</b> 支持所有内外链图片，调用的是原图，加载速度会有所影响。<br /><br />
				<b>生成缩略图</b> 仅支持本地上传到媒体库中的图片生成缩略图，外链调用原图。
				',
			),
			...
			array(
				...
				'default' => $imgdefault . '/random/320.jpg',
				'preview' => true,
				'after'   => '<span style="color:#c40000">必须重新上传一张图片，用于延迟加载生成相应的占位图。</span>支持阿里云OSS、七牛云、又拍云、腾讯COS',
			),
