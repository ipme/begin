	...
	<div class="pagewrapper clearfix n-mode" id="profile" >
		...
		<aside class="pagesidebar" style="top:44px;">
			<ul class="pagesider-menu">
				<li <?php if((isset($_GET["pd"]) && $_GET["pd"]=='info') || !isset($_GET["pd"])){?>class="active"<?php }?> ><a href="?pd=info"><i class="be be-timerauto"></i><span class="pdt">我的信息</span></a></li>
				...
				<?php if (zm_get_option('shar_favorite')) { ?>
					<li <?php if(isset($_GET["pd"]) && $_GET["pd"]=='favorite'){?>class="active"<?php }?> ><a href="?pd=favorite"><i class="be be-star"></i><span class="pdt">我的收藏</span></a></li>
				<?php } ?>
				<?php if ( zm_get_option( 'follow_btn' ) ) { ?>
					<li <?php if(isset($_GET["pd"]) && $_GET["pd"]=='follow'){?>class="active"<?php }?> ><a href="?pd=follow"><i class="be be-favoriteoutline"></i><span class="pdt">我的关注</span></a></li>
				<?php } ?>
				<?php if ( zm_get_option( 'follow_btn' ) ) { ?>
					<li <?php if(isset($_GET["pd"]) && $_GET["pd"]=='fans'){?>class="active"<?php }?> ><a href="?pd=fans"><i class="be be-favorite"></i><span class="pdt">我的粉丝</span></a></li>
				<?php } ?>
				<?php if ( zm_get_option( 'tou_admin_url' ) ) { ?>
					<li class="tou-url"><a href="<?php echo home_url(); ?>/wp-admin/post-new.php" target="_blank"><i class="be be-edit"></i><span class="pdt"><?php echo zm_get_option( 'tou_txt' ); ?></span></a></li>
				<?php } else { ?>
					<?php if ( zm_get_option( 'tou_url' ) ) { ?>
					<li class="tou-url"><a href="<?php echo get_permalink( zm_get_option( 'tou_url' ) ); ?>" target="_blank"><i class="be be-edit"></i><span class="pdt"><?php echo zm_get_option( 'tou_txt' ); ?></span></a></li>
					<?php } ?>
				<?php } ?>
				<!-- be end -->
				<!-- 
			...
			<div class="pd-menu-switch fd">
				...
				<div class="menu-hide"><i class="be be-sidebar-on"></i></div>
			</div>
		</aside>
			...
			<div id="my-favorite">
					<h4>
						...
						<?php 
							...
							$favorites     = $favorite_post->get_favorites( $post_type, $current_user->ID );
							echo '<span class="m-number">' . count( $favorites ) . '</span>'
						?>
					</h4>
					<div class="my-user"><?php my_favorite(); ?></div>
				<div class="clear"></div>
			</div>
			 <?php } elseif ( isset($_GET["pd"] ) && $_GET["pd"]=='follow') { ?>
				<?php if ( zm_get_option( 'follow_btn' ) ) { ?>
				<div id="my-follow">
						<div class="my-user"><?php follow_list(); ?></div>
					<div class="clear"></div>
				</div>
				<?php } ?>

			 <?php } elseif ( isset($_GET["pd"] ) && $_GET["pd"]=='fans') { ?>
				<?php if ( zm_get_option( 'follow_btn' ) ) { ?>
				<div id="my-follow">
						<div class="my-user"><?php fans_list(); ?></div>
					<div class="clear"></div>
				</div>
				<?php } ?>
						...
						<?php
							if($list) {
								foreach($list as $value)
								{
									...
									echo "<td>$value->ice_price</td>\n";
									echo "<td>$value->ice_time</td>\n";
									echo "<td><a href='".get_bloginfo('wpurl').'/wp-content/plugins/erphpdown/download.php?url='.$value->ice_url."' target='_blank'><i class='dashicons dashicons-cloud-saved'></i>下载文件</a></td>\n";
									echo "</tr>";
								}
							}
							else
