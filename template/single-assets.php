...
<?php
if ( zm_get_option( 'single_assets' ) ) {
	global $post;
...
<div class="betip single-assets cms-assets-<?php echo zm_get_option( 'single_assets_f' ); ?>">
	...
	<?php } else { ?>
		<?php echo do_shortcode( '[be_ajax_post style="assets" terms="' . $catid . '" btn="no" posts_per_page="' . zm_get_option( 'single_assets_n' ) . '" more="more"]' ); ?>
	<?php } ?>
<?php } ?>
