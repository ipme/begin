			...
			<div class="g-col">
				<div class="flexbox-grid">
					...
					<div class="cat-portfolio-main">
						<div class="cat-portfolio-area" style="width: <?php echo be_build( get_the_ID(), 'group_portfolio_l' ); ?>%">
						...
						<div class="cat-portfolio-area" style="width: <?php echo be_build( get_the_ID(), 'group_portfolio_z' ); ?>%;">
