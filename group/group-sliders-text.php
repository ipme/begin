...
<?php if ( co_get_option( 'group_slides_text' ) ) { ?>
	<?php 
		$addslides = ( array ) co_get_option( 'group_slides_text_add' );
	...
	?>
		...
		<div class="g-row g-line group-slider-text group-slider-text-a group-slider-img-text<?php echo $bg; ?>" <?php aos(); ?>>
			<div class="g-col">
				...
				<?php co_help( $text = '公司主页 → 图文幻灯', $number = 'group_slides_text_s', $go = '图文幻灯' ); ?>
			</div>
		</div>
	<?php } ?>
<?php } ?>