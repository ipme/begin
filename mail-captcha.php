...
if ( isset( $_POST['action'] ) && $_POST['action'] == 'eer_captcha' && isset( $_POST['user_name'] ) && $_POST['user_name'] ) {
...
if ( isset( $_POST['action'] ) && $_POST['action'] == 'eer_captcha' && filter_var( $_POST['email'], FILTER_VALIDATE_EMAIL ) ) {
